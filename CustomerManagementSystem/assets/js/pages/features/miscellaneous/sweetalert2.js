...
var KTSweetAlert2Demo = function () {
	var _init = function () {
		...
		$("#kt_sweetalert_cozuldu").click(function(e) {
			Swal.fire({
				title: "Destek Kaydı",
				text:"Sorunum Çözüldü Olarak Değiştirildi", 
				icon:"success", 
				buttonsStyling: true, 
			...
			$("#kt_sweetalert_otoodemeaktif").click(function(e) {
			Swal.fire({
			...
			$("#kt_sweetalert_destekac").click(function(e) {
			Swal.fire({
				title: "Yeni Destek Kaydı Açıldı",
				icon:"success", 
				buttonsStyling: true, 
				confirmButtonText: "Tamam"
			});
		...
		// Sweetalert Demo 5
		$("#kt_sweetalert_destektekrar").click(function (e) {
			Swal.fire({
				title: "Destek Kaydı",
				text: "Tekrar açılacak onaylıyor musunuz?",
				icon: "info",
				buttonsStyling: false,
				confirmButtonText: "Tamam",
				showCancelButton: true,
		...
		// Sweetalert Demo 5
		$("#kt_sweetalert_odemeoanay").click(function (e) {
			Swal.fire({
				title: "Yeni Kart Kaydı ",
				text: "İşlemini Onaylıyormusunuz?",
				icon: "info",
				buttonsStyling: false,
				confirmButtonText: "Tamam",
				showCancelButton: true,
	...
	$('#kt_sweetalert_yonlendirme1').click(function (e) {
			Swal.fire({
	...
	$('#kt_sweetalert_yonlendirme2').click(function (e) {
			Swal.fire({
				title: 'Ödeme Gerçekleştiriliyor',
